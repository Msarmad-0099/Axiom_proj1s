...
const notification = document.getElementById('slider-contaienr');
//Get element from class
const hangmanParts = document.querySelectorAll('.hangman-parts');
//Creating an Array of words to select from
const wordPool = ['facebook','yotube','instagram','hangman','tiktok'];
//Selecting a word at random from pool
let selectedWord = wordPool[Math.floor(Math.random() * wordPool.length)];
//To check here console.log(selectedWord)
//Array to classify the input of user
